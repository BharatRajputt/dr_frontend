...
const Contacts = () => {
  return (
    ...
    <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
      ...
      <p className='text-gray-500'>5407,rangwasa rau <br /> suite,Indore ,M.P.</p>
      <p className='text-gray-500'>Tel:8629960466 <br />bp@180277@gmail.com</p>
      <p className='font-semibold text-lg text-gray-600'> Carrers  at PRESCRIPTO </p>
      <p className='text-gray-500'> Learn  more about our team and join openings </p>
